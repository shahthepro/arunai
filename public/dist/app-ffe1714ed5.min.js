...
!function(){"use strict";function PagesService($resource){return $resource("/api/pages/:pageId",{pageId:"@_id"},{update:{method:"PUT"},query:{method:"GET",isArray:!0},getBySlug:{method:"GET",url:"/api/pages/slugged/:slug"}})}angular.module("pages").factory("PagesService",PagesService),PagesService.$inject=["$resource"]}();
