...
!function(){"use strict";function routeConfig($stateProvider){$stateProvider.state("admin.assignments",{abstract:!0,url:"/assignments",template:"<ui-view/>"}).state("admin.assignments.list",{url:"",templateUrl:"/modules/courses/client/views/list-assignments.client.view.html",controller:"AssignmentsListController",controllerAs:"vm",data:{roles:["admin"],pageTitle:"Course Assignments List"}}).state("admin.assignments.create",{url:"/create",templateUrl:"/modules/courses/client/views/form-assignment.client.view.html",controller:"AssignmentsController",controllerAs:"vm",resolve:{assignmentResolve:newAssignment},data:{roles:["admin"],pageTitle:"Create Course Assignmentss"}}).state("admin.assignments.edit",{url:"/:assignmentId/edit",templateUrl:"/modules/courses/client/views/form-assignment.client.view.html",controller:"AssignmentsController",controllerAs:"vm",resolve:{assignmentResolve:getAssignment},data:{roles:["admin"],pageTitle:"Edit Assignment"}})}function getAssignment($stateParams,AssignmentsService){return AssignmentsService.get({assignmentId:$stateParams.assignmentId}).$promise}function newAssignment(AssignmentsService){return new AssignmentsService}angular.module("courses.admin.routes").config(routeConfig),routeConfig.$inject=["$stateProvider"],getAssignment.$inject=["$stateParams","AssignmentsService"],newAssignment.$inject=["AssignmentsService"]}();
!function(){"use strict";function routeConfig($stateProvider){$stateProvider.state("admin.courses",{abstract:!0,url:"/courses",template:"<ui-view/>"}).state("admin.courses.list",{url:"",templateUrl:"/modules/courses/client/views/list-courses.client.view.html",controller:"CoursesListController",controllerAs:"vm",data:{roles:["admin"],pageTitle:"Courses List"}}).state("admin.courses.create",{url:"/create",templateUrl:"/modules/courses/client/views/form-course.client.view.html",controller:"CoursesController",controllerAs:"vm",resolve:{courseResolve:newCourse},data:{roles:["admin"],pageTitle:"Courses Create"}}).state("admin.courses.edit",{url:"/:courseId/edit",templateUrl:"/modules/courses/client/views/form-course.client.view.html",controller:"CoursesController",controllerAs:"vm",resolve:{courseResolve:getCourse},data:{roles:["admin"],pageTitle:"Edit Course {{ courseResolve.name }}"}})}function getCourse($stateParams,CoursesService){return CoursesService.get({courseId:$stateParams.courseId}).$promise}function newCourse(CoursesService){return new CoursesService}angular.module("courses.admin.routes").config(routeConfig),routeConfig.$inject=["$stateProvider"],getCourse.$inject=["$stateParams","CoursesService"],newCourse.$inject=["CoursesService"]}();
...
!function(){"use strict";function CoursesController($scope,$state,$window,Authentication,course,DepartmentsService){function remove(){$window.confirm("Are you sure you want to delete?")&&vm.course.$remove($state.go("admin.courses.list"))}function save(isValid){function successCallback(res){$state.go("admin.courses.list")}function errorCallback(res){vm.error=res.data.message}return isValid?void(vm.course._id?vm.course.$update(successCallback,errorCallback):vm.course.$save(successCallback,errorCallback)):($scope.$broadcast("show-errors-check-validity","vm.form.courseForm"),!1)}var vm=this;vm.authentication=Authentication,vm.departments=DepartmentsService.query(),vm.course=course,vm.error=null,vm.form={},vm.remove=remove,vm.save=save}angular.module("courses").controller("CoursesController",CoursesController),CoursesController.$inject=["$scope","$state","$window","Authentication","courseResolve","DepartmentsService"]}();
